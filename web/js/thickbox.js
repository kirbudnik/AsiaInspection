...
var tb_pathToImage = "https://s3.asiainspection.com/images/loadingAnimation.gif";
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			if(url.indexOf('TB_iframe') != -1){
					...
					if(special == "newpop"){
						$("#TB_window").append("<div id='TB_closeAjaxWindow' style='padding-top:0px; padding-bottom:0px;'><a href='#' id='TB_closeWindowButton' title='Close' style='position:absolute; margin-left:15px; margin-top:0px;'><img src='https://s3.asiainspection.com/images/whitecross.png' width='24px' border='0' /></a></div><iframe frameborder='0' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;' onload='tb_showIframe()'> </iframe>").css("border-radius","3px");
					...
					if($("#TB_window").css("display") != "block"){
						if(params['modal'] != "true"){
							if(special == "newpop"){
								$("#TB_window").append("<div id='TB_closeAjaxWindow' style='padding-top:0px; padding-bottom:0px;'><a href='#' id='TB_closeWindowButton' style='position:absolute; margin-left:15px; margin-top:0px;'><img src='https://s3.asiainspection.com/images/whitecross.png' width='24px' border='0' /></a></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px'></div>").css("border-radius","3px");
								$("#TB_overlay").css("opacity","0.85");
							}else{
